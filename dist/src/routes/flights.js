...
// dargli un senso
router.get("/:idAirport/:nSeats", [
    express_validator_1.param("idAirport").isMongoId(),
    express_validator_1.param("nSeats").isNumeric(),
    express_validator_1.query(["checkOut", "checkIn"]).isISO8601(),
    express_validator_1.query("destination").isString()
